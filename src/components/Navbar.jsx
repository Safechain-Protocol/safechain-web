  ...
  return (
    <nav className="border navbar navbar-expand-lg navbar-light p-3">
      <a
        ...
        href="/"
      >
        <p className="text-violet font-weight-bold ml-3 my-auto">MetaVault</p>
      </a>
      <button
      ...
      <div className="mr-3 collapse navbar-collapse" id="navbarNavAltMarkup">
        <div className="navbar-nav ml-auto">
          <a href="/">
            <p className="text-violet font-weight-bold h-100 d-flex align-items-center ml-3 mr-5 mobile-extra-top-margin">
              Getting Started
            </p>
          </a>
          <div className="ml-3">
